...
<script>
  ...
  data() {
    ...
    show(params){
        ...
        console.log("报修show方法中的"+params)
        this.$http.post(this.GLOBAL.serverPath+'/change/fixed',
            {
            ...
            console.log("修改里面的"+res.body.name);
        }
        )
    ...
    reback(params){
        console.log("进入reback方法"+params);
        console.log(params);
        this.$http.post(this.GLOBAL.serverPath+'/change/boomed',
            {
                biannum:params.row.biannum
            },
            {
     ...
     handleSubmit(account) {
       var that=this
        this.$http.post(this.GLOBAL.serverPath + '/user/findstayed',
            {
